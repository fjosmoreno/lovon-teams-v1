...
export const DEPARTMENT_TEMPLATES: DepartmentTemplate[] = [
  ...
  },
  {
    ...
    emoji: "▲",
    accent: "blue",
    headRole: "VP de Vendas",
    headEmoji: "▲",
    headSpecialty: "Outbound & Pipeline",
    model: "Gemini Flash",
    keywords: ["venda", "receita", "cliente", "pipeline", "mrr", "lead", "prospec", "vp-vendas", "vp vendas"],
  },
  {
    id: "marketing",
    name: "Marketing",
    emoji: "✦",
    accent: "acid",
    headRole: "CMO (Diretor de Marketing)",
    headEmoji: "✦",
    headSpecialty: "Brand & Content",
    model: "Qwen 2.5",
    keywords: ["marketing", "marca", "campanha", "conteudo", "social", "ads", "copy", "cmo", "diretor de marketing"],
  },
  {
    id: "engineering",
    name: "Engenharia",
    emoji: "◇",
    accent: "green",
    headRole: "CTO (Diretor de Tecnologia)",
    headEmoji: "◇",
    headSpecialty: "Code & Architecture",
    model: "Claude Sonnet 4",
    keywords: ["produto", "codigo", "tech", "dev", "api", "feature", "bug", "deploy", "infra", "cto", "tecnologia", "arquitetura"],
  },
  {
    id: "research",
    name: "Pesquisa",
